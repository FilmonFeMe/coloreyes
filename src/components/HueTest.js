...
const hues1 = ["#ab756d","#aa7469","#aa7365","#a77161","#a57260","#a4725c","#a47258","#a37356","#a27554","#a37752","#a37951","#a47b4e","#a27b49","#a17d48","#a28149","#9f844a","#9a8347","#9c8a4c","#9a8a4c","#95894c"];
const hues2 = ["#8e8f57","#8b9058","#88915c","#859360","#809262","#7e9566","#7e9568","#78966a","#75966c","#71986d","#6a9871","#699973","#699a77","#609877","#5a947a","#5b967e","#589681","#599784","#559685","#549988"];
const hues3 = ["#52968c","#50978f","#499892","#459995","#4b9997","#4b9898","#50999d","#5597a0","#5496a2","#5996a3","#5f95a5","#6695a4","#6792a5","#6c92a9","#6b8da6","#7290aa","#728da9","#768daa","#788aa8","#7985a2"];
const hues4 = ["#8489a6","#8888a6","#8a88a4","#8f88a4","#9287a3","#9386a0","#98859f","#98849c","#9b8198","#a08298","#9d7c91","#a37e92","#a77e90","#a77b8c","#a87988","#aa7784","#ac7982","#ac757e","#ab757a","#a97375"];

class HueTest extends Component {
  constructor(props) {
    super(props);
    this.state = {
      row1:shuffleArray(["#ab756d","#aa7469","#aa7365","#a77161","#a57260","#a4725c","#a47258","#a37356","#a27554","#a37752","#a37951","#a47b4e","#a27b49","#a17d48","#a28149","#9f844a","#9a8347","#9c8a4c","#9a8a4c","#95894c"]),
      row2:shuffleArray(["#8e8f57","#8b9058","#88915c","#859360","#809262","#7e9566","#7e9568","#78966a","#75966c","#71986d","#6a9871","#699973","#699a77","#609877","#5a947a","#5b967e","#589681","#599784","#559685","#549988"]),
      row3:shuffleArray(["#52968c","#50978f","#499892","#459995","#4b9997","#4b9898","#50999d","#5597a0","#5496a2","#5996a3","#5f95a5","#6695a4","#6792a5","#6c92a9","#6b8da6","#7290aa","#728da9","#768daa","#788aa8","#7985a2"]),
      row4:shuffleArray(["#8489a6","#8888a6","#8a88a4","#8f88a4","#9287a3","#9386a0","#98859f","#98849c","#9b8198","#a08298","#9d7c91","#a37e92","#a77e90","#a77b8c","#a87988","#aa7784","#ac7982","#ac757e","#ab757a","#a97375"]),
      row1Score:0,
      row2Score:0,
      row3Score:0,
      row4Score:0,
      ...
      <div className="Hues">
       <h1>Hue Test</h1>
        ...
        <div id="container-hue">
          ...
          <button className="hue-btn" type="button" onClick={this.generateResults}>DONE</button>
        </div>
      </div>
    );
  }
