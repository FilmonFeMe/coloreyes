  ...
  render(){
    return (
      <div className="share">
        ...
        <div className="sm-join"><a target="_blank" href="https://www.facebook.com/groups/colorblindusa/"><img className="fb-join" src="images/joinus.png" alt="Join us"></img></a><span> Join our colorblind community on Facebook</span></div>
      </div>
    );
  }
}
