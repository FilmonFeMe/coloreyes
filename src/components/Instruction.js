...
class Instruction extends Component {
  render(){
    return (
      <div>
        <p>In a moment, you will be shown a large circle made of many smaller circles, which vary in color.  This is what is known as an “Ishihara plate”.  Used as the standard in color vision testing over the past century, this method of color vision testing remains the most widely-used and accepted today.
